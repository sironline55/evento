...
const C = {
  ...
  border: 'rgba(255,255,255,0.07)', muted: 'rgba(255,255,255,0.45)',
}
...
export default function SuperAdminLayout({ children }: { children: React.ReactNode }) {
  ...
  if (loading) return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center',
      justifyContent: 'center', background: '#FBF8F5' }}>
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', background: '#FBF8F5' }} dir="rtl">
      ...
      <aside style={{
        ...
        <div style={{ padding: '24px 18px 20px', borderBottom: `1px solid ${C.border}` }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <div style={{
              width: 36, height: 36, background: C.primary, borderRadius: 10,
        ...
        <div style={{ margin: '12px 12px 4px', padding: '6px 12px',
          background: 'rgba(244,125,49,0.15)', borderRadius: 8,
